...
<header class="header-crearevento">
	<div class="header-content">
		<div class="container">
			...
			<p>Especifique los WODs del evento</p>
		</div>
		<div class="container"> 
							...
							<?php foreach ($error['data'] as $key => $value): ?>
								<div class="entry form-group col-md-12">
									...
									<div class="wodTipo">
										...
										<div <?php if( ($value['tipo'] != 3) && ($value['tipo'] != 4) ) echo "style=\"display: none;\"" ?> class="form-group col-md-12 fortime amrap penalfortime">
									...
									<span class="col-md-12" style="width:100%;">
										<button class="btn btn-default btn-remove" type="button">
											<span class="glyphicon glyphicon-minus"></span> Remover WOD
										</button>
									</span>
								</div>
							<?php endforeach; ?>
