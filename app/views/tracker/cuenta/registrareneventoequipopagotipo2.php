...
<header class="header-eventos">
	<div class="header-content">
		<div class="header-content-inner">
			<h1>Pago Directo</h1>
			<hr class="light">
			<p>Introduzca los datos de su pago para terminar el proceso de registro</p>
			...
			<div class="col-sm-6 col-sm-push-3">
				...
				<div class="form-group col-sm-6 <?php if (isset($error['campos']['numreferencia'])) echo 'has-error'; ?>">
					<label class="control-label">N&uacute;mero de recibo</label>
					<input type="text" name="numreferencia" class="form-control" id="" value="<?php echo $error['data']['banco']; ?>" >
				</div>

				<div class="form-group col-sm-6 <?php if (isset($error['campos']['monto'])) echo 'has-error'; ?>">
