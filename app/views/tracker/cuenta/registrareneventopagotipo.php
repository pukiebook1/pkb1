	...
	<div class="header-content">
		<div class="header-content-inner">
			...
			<div class="col-sm-6 col-sm-push-3">
				<div class="col-sm-12">
					<?php if ($data['evento']->id == 86) {?>  
					<a href="<?php echo DIR; ?>cuenta/registrarseevento/<?php echo $data['evento']->internalURL;?>/<?php echo $data['categoria']->id; ?>/registrarPago/4" class="btn btn-default btn-margin"><i class="fa fa-money"></i> Pago online</a><br>
					</form>		     
