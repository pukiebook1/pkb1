			...
			<form role="form" action="" method="POST">
				...
				<div class="col-sm-6 col-sm-push-3">
					...
					<div class="form-group col-sm-6 <?php if (isset($error['campos']['banco'])) echo 'has-error'; ?>">
						...
						<input type="text" name="address" class="form-control" id="" value="<?php echo $error['data']['monto']; ?>" >
					</div>
					<div class="form-group col-sm-6 <?php if (isset($error['campos']['banco'])) echo 'has-error'; ?>">
						<label class="control-label">Número de teléfono para facturación:</label>
						<input type="text" name="telefono" class="form-control" id="" value="<?php echo $error['data']['monto']; ?>" >
					</div>
