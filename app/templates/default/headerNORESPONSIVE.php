...
<head>
	...
	<?php if ($data['fbablePerfil']): ?>
		<meta property="og:title" content="<?php echo $data['persona']->nombre." ".$data['persona']->apellido;?>" />
		<meta property="og:image" content="<?php echo DIR.$data['persona']->fotoPath;?>" />
	<?php else: ?>
		<meta property="og:image" content="<?php echo DIR;?>icono.jpg" />
	<?php endif; ?>
