...
<header class="header-crearevento">
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <div class="alert alert-warning"><strong>Aviso:</strong> El evento no saldr&aacute; en la lista de eventos hasta ser aprobado.</div>
            <a href="#info" class="btn btn-margin btn-primary page-scroll"><i class="fa fa-info-circle"></i> M&aacute;s Informaci&oacute;n</a>
            <a href="<?php echo DIR; ?>cuenta/crearevento/crear" class="btn btn-margin btn-primary page-scroll"><i class="fa fa-arrow-circle-right"></i> Comenzar!</a>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-8 col-lg-offset-2 text-center">
                ...
                <p class="text-faded">
                    ...
                    <div class="col-sm-6 text-center">
                        ...
                        <p><a class="btn btn-link" href="tel:+573225135940">+573225135940</a></p>
                    </div>
                    <div class="col-sm-6 text-center">
