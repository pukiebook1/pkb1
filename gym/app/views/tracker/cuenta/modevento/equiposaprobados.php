							...
							<tr>
								<td>
									<div class="atletaContainer">
										<div class="atleta">
											<a class="btn" target="_blank" href="<?php echo DIR; ?>equipo/<?php echo $valueAtl->equipoId;?>"><?php echo $valueAtl->nombre; ?></a>
										</div>
									</div>
								</td>
								<td>
								...
								<?php if (isset($valueAtl->pagoId)): ?>
									<td><a target="_blank" href="<?php echo DIR; ?>pagosEventoEquipo/<?php echo $valueAtl->pagoId; ?>" class="btn">Ver</a></td>
								<?php else: ?>
									<td></td>
								<?php endif ?>
