...
<header class="header-eventos">
	<div class="header-content">
		<div class="header-content-inner">
			...
			<hr class="light">
			<p>Escoga la categor&iacute;a en la cual participar&aacute;.</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 text-center">
				...
				<p class="text-faded">No se encontraron categor&iacute;s para registrarse.</p>
				<?php else: ?>
				<p class="text-faded"><?php echo count($data['categorias'])." categor&iacute;as"; ?></p>

					<?php foreach ($data['categorias'] as $keyE => $valueE): ?>
						<a class="btn btn-margin btn-default" href="<?php echo DIR; ?>cuenta/registrarseevento/<?php echo $data['evento']->internalURL; ?>/<?php echo $data['equipo']->id; ?>/e/<?php echo $keyE; ?>"><i class="fa fa-list-ol"></i> <?php echo $valueE->nombre; ?></a>
					<?php endforeach ?>
