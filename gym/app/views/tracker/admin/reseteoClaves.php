		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 text-center">
				<div class="control-group" id="fields">
					<h2 class="section-heading">Correos</h2>
					<hr>
					<div class="controls">    
						<form role="form" autocomplete="off" action="" method="POST">
							...
							<?php foreach ($error['data'] as $key => $value): ?>
								<div class="entry input-group col-lg-12">
									<input class="form-control" name="correos[]" type="text" placeholder="Correo" value="<?php echo $value; ?>"/>
							...
							<?php endforeach ?>
								<div class="entry input-group col-lg-12">
									<input class="form-control" name="correos[]" type="text" placeholder="Correo" value=""/>
									<span class="input-group-btn">
								...
								<div class="form-group col-sm-12">
									<button name="submit" type="submit" class="btn btn-margin btn-primary"><i class="fa fa-arrow-circle-right"></i> Resetear</button>
								</div>                               
							</div>
						</form>
					</div>
