...
<header class="header-crearevento">
    <div class="header-content">
        <div class="container">
            ...
            <br/>
            <h1>Eliminaci&oacute;n de Box</h1>
            <!-- <p>Plan del evento: <?php echo $data['evento']->nombrePlan; ?></p> -->
            <hr class="light">

            <p>Est&aacute; seguro de querer eliminar este Box?</p>
        </div>
        <div class="container">    
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6 col-md-push-3">
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label"><input class="form-control" name="eliminar" type="checkbox"/>Deseo eliminar el Box</label>
                    </div>

                    <div class="form-group col-lg-12">
                        <a class="btn btn-default btn-margin" href="<?php echo DIR; ?>cuenta/misboxes"><i class="fa fa-chevron-circle-left"></i> Volver</a>
